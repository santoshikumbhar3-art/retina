        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4 rounded-md shadow-sm">
            {[
              ...
              <div key={field.key}>
                <label htmlFor={`login-${field.key}`} className="block text-sm font-medium text-gray-700 mb-1">{field.label}</label>
                <input
                  id={`login-${field.key}`}
                  type={field.type}
                  required
          ...
          <div>
            <button
              ...
              aria-label={isLoading ? "Signing in, please wait" : "Sign in to Healthway Portal"}
            >
